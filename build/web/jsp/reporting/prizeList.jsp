...
<script type="text/javascript">
	function loadSubjectList(selectedValue) {
			document.form.action = "loadSubjectsForPrizeListReport.htm";
...
<body>
	<div id="page_container">
		<div id="breadcrumb_area">
			...
			<div class="help_link">
				<a href="#"
					onClick="PopupCenterScroll('<c:url value="resources/html/akura-help/topics/reporting/prizeTopListReportHelp.html"/>','helpWindow',780,550)"><img
		...
		<div id="content_main">
			...
			<div class="section_box">
				<div class="section_box_header">
					<h2>
						<spring:message code="REPORT.Prize.List" />
					</h2>
				</div>
				...
				<div class="section_full_inside">
					...
					<div class="box_border">
						<form:form action="subjectPrizeListReport.htm" method="POST"
							commandName="prizeListReportTemplate" name="form">
							...
							<table>
								...
								<tr>
									<td><span class="required_sign">*</span> <label><spring:message
												code="REPORT.PRIZE.LIST.GRADE" /> </label></td>

									<td><form:select path="grade.gradeId"
											onchange="loadSubjectList(this.value);">
											<option value="0">
								...
								<tr>
									<td>&nbsp;&nbsp;&nbsp;<label><spring:message
												code="REPORT.PRIZE.LIST.GRADE.SUBJECT" /> </label></td>

									<td><form:select path="gradeSubject.gradeSubjectId">
											<option value="0">
												<spring:message code="application.drop.down" />
											</option>
											<form:options items="${gradeSubjectList}"
												itemValue="gradeSubjectId" itemLabel="subject.description" />
								...
								<tr>
									<td><span class="required_sign">*</span> <label><spring:message
												code="REPORT.PRIZE.LIST.YEAR" /> </label></td>
								...
								<tr>
									<td><span class="required_sign">*</span> <label><spring:message
												code="REPORT.PRIZE.LIST.NO.OF.PRIZES" /> </label></td>
