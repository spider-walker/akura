 ...
 */
public class StudentTermMarkPerformance extends BaseDomain implements Serializable {
     ...
     * Default constructor.
     */
    public StudentTermMarkPerformance() {
     ...
     * @param isabsent the absent status.
     */
    public StudentTermMarkPerformance(float marksVlaue, String termValue, String subjectValues, int studentIdVal,
            Date yearVal, int studentTermMarkIdVal, boolean isabsent) {
