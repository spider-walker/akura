 ...
 */
public class StudentScholarshipId implements java.io.Serializable {
     ...
     */
    public StudentScholarshipId(int intStudentId, int intScholarshipId) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof StudentScholarshipId)) {
            return false;
        }
        StudentScholarshipId castOther = (StudentScholarshipId) other;
        
        return (this.getStudentId() == castOther.getStudentId())
                && (this.getScholarshipId() == castOther.getScholarshipId());
    }
    ...
    public int hashCode() {
         ...
         * this.getScholarshipId(); return result;
         */
    ...
    public String toString() {
        ...
        return STUDENT_ID + studentId + SCHOLARSHIP_ID + scholarshipId;
    }
