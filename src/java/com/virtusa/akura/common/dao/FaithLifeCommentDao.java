...
/**
 * This interface provides all the persistence related operations for FaithLifeComment.
 *
 * @author Virtusa Corporation
 */
public interface FaithLifeCommentDao extends BaseDao<FaithLifeComment> {
     ...
     */
    List<FaithLifeComment> findFaithLifeCommentByCategory(int categoryId) throws AkuraAppException;
