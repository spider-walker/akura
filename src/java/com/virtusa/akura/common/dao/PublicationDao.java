...
/**
 * This interface provides persistence layer functionality for the publication object.
 *
...
public interface PublicationDao extends BaseDao<Publication> {
    ...
    /**
     * Returns the maximum, minimum and total number of publication items.
     *
     * @return - a list contains the total number of publications.
     * @throws AkuraAppException - The exception details that occurred when processing.
     */
    List<Long> getMaxNoOfPublications() throws AkuraAppException;
    ...
    /**
     * Returns a list of publication which exists on the table.
     *
     * @param header - the description of the header.
     * @return - a list of exist publications
     * @throws AkuraAppException - The exception details that occurred when processing.
     */
    List<Publication> isExistPublication(final String header)throws AkuraAppException;
}
