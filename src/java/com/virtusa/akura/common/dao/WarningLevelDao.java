 ...
 */
public interface WarningLevelDao extends BaseDao<WarningLevel> {
    ...
    public boolean isExistWarningLevel(String description, String color) throws AkuraAppException;
