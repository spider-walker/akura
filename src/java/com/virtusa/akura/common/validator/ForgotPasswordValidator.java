...
/**
 * This validator class validates the fields of the ForgotPasswordForm.
 *
...
public class ForgotPasswordValidator implements Validator {
    ...
    /**
     * The actual USerLogin Validator method validates to make sure that the UserLogin Object passed is null
     * or empty.
     *
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (userLogin.getUsername().trim().isEmpty()) {
