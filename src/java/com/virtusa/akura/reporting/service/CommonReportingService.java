...
public interface CommonReportingService {
     ...
     * 
     * @param studentTemplate collect user input.
     * @return {@link JRBeanCollectionDataSource}.
     * @throws AkuraAppException - The detailed exception.
     */
    JRBeanCollectionDataSource getStudentScholarshipList(StudentScholarshipTemplate studentTemplate)
            throws AkuraAppException;
