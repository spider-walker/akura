...
/**
 * This class validates fields for input data entered to generate subject prize list report.
 * 
 * @author Virtusa Corporation
 */
public class SubjectPrizeTopListValidator implements Validator {
    ...
    public void validate(Object object, Errors errors) {
        ...
        if (prizeListReportTemplate.getGrade().getGradeId() == 0
                || "0".equals(prizeListReportTemplate.getYear())) {
