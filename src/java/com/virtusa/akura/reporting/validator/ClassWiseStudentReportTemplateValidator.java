 ...
 */
public class ClassWiseStudentReportTemplateValidator implements Validator {

    /** The Constant CLASS_GRADE_ID. */
    private static final String CLASS_GRADE_ID = "classGradeId";

    /**
     * ClassWiseStudentReportTemplate is the class of the actual object instance that is to be validated.
     *
    ...
    public boolean supports(Class<?> clazz) {
        ...
        return ClassWiseStudentReportTemplate.class.isAssignableFrom(clazz);
    }
    ...
    public void validate(Object object, Errors errors) {
        ...
        ClassWiseStudentReportTemplate classWiseStudentReportTemplate = (ClassWiseStudentReportTemplate) object;

        if (classWiseStudentReportTemplate.getClassGradeId() == 0) {
