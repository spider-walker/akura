...
/**
 * class to validate Per Day Staff Category Wise Attendance form.
 */
public class PerDayStaffCategoryWiseAttendanceValidator implements Validator {
    ...
    /** attribute for holding attribute concider date. */
    public static final String DATE = "dateConsidered";
    ...
    public void validate(Object object, Errors errors) {
        ...
        if (perDayAttendanceTemplate.getDateConsidered().equals(EMPTY)) {
            errors.rejectValue(DATE, MANDATORY_ERROR_MESSAGE);
        }
