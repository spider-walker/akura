...
/**
 * This interface provides persistence layer functionality for the ParentDonation object.
 * 
 * @author Virtusa Corporation
 */
public interface ParentDonationDao extends BaseDao<ParentDonation> {
    /**
