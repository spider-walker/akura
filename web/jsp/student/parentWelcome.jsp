...
<script type="text/javascript">
	function nextOrPrevPublication(nextOrPrev , pageNo){
			...
			document.formEvent.action = "getParentPagination.htm";
...
<div id="page_container">
  ...
  <h1><spring:message code="PARENT.PARENT_WELCOME.WELCOME_MESSAGE"/> </h1>
    <div id="content_main">
    <div class="clearfix"></div>
    <div class="section_box">
	  ...
	  <div class="section_box_header">
          <h2><spring:message code="PARENT.PARENT_WELCOME.EVENTS"/></h2>
        </div>
